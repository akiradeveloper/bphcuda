...
__host__  __device__
bool are_equal(thrust::tuple<A,B,C> a, thrust::tuple<A,B,C> b){
...
template<typename A, typename B, typename C>
__host__  __device__
bool operator==(thrust::tuple<A,B,C> a, thrust::tuple<A,B,C> b){
  return are_equal(a, b);
}

template<typename A, typename B, typename C>
__host__
std::ostream& operator<<(std::ostream &os, thrust::tuple<A,B,C> t){
  std::stringstream ss;
  ss << "(";
  ss << thrust::get<0>(t) << ", ";
  ss << thrust::get<1>(t) << ", ";
